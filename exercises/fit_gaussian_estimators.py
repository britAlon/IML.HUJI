...
def test_multivariate_gaussian():
    ...
    observations = np.random.multivariate_normal([0, 0, 4, 0], cov_matrix, NUMBER_OF_SAMPLES)
    ...
    print(np.around(expectations[np.argmax(log_likelihood_arr)], 4))
